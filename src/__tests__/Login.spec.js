...
//     expect(inputPassword.value).toBe(undefined)
...
//     const { inputPassword, inputEmail , loginSubmitBtn } = setup();
//     expect(inputPassword.value).toBe(undefined)
//     expect(inputEmail.value).toBe(undefined)
...
//     expect(localStorage.getItem).toHaveBeenCalledWith('cocktailsToken');
//     expect(localStorage.getItem).toHaveBeenCalledWith('mealsToken');
// });
});
