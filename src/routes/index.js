...
import { DetailsRecipeDrink, DetailsRecipeFood, DoneRecipes, Drinks, ExploreDrinks, ExploreFoods, ExploreIngredientsFood, ExploreRecipes, ExploreRegionalFoods, FavoriteRecipes, Login, NotFound, Profile, ProgressRecipesDrink, ProgressRecipesFood, ExploreIngredientsDrink } from '../pages';
  ...
  render() {
    return (
      <Switch>
        ...
        <Route path="/explorar/bebidas/ingredientes" component={ExploreIngredientsDrink} />
